...
void Game::CreateGeometry()
{
	...
	unsigned int fireTexture = Graphics::LoadTexture(FixPath(AssetPath + L"Textures/Particles/Black/fire_01.png").c_str());
	unsigned int twirlTexture = Graphics::LoadTexture(FixPath(AssetPath + L"Textures/Particles/Black/twirl_02.png").c_str());
	unsigned int starTexture = Graphics::LoadTexture(FixPath(AssetPath + L"Textures/Particles/Black/star_04.png").c_str());
	unsigned int flameAnimatedTexture = Graphics::LoadTexture(FixPath(AssetPath + L"Textures/Particles/flame_animated.png").c_str());
...
void Game::Draw(float deltaTime, float totalTime)
{
	...
	// Draw all emitters after the sky
	for (auto& e : emitters)

...
void Game::CreateGeometry()
{
	...
	computeMat->SetAlbedoIndex(RWTextures[0].DescriptorHeapIndex);
	computeMat->SetNormalMapIndex(RWTextures[1].DescriptorHeapIndex);
	computeMat->SetRoughnessIndex(RWTextures[2].DescriptorHeapIndex);
	computeMat->SetMetalnessIndex(RWTextures[3].DescriptorHeapIndex);
...
void Game::Draw(float deltaTime, float totalTime)
{
	...
	// Run compute shader
	{
		...
		computeData.albedoTextureIndex = RWTextures[0].DescriptorHeapIndex;
		computeData.normalTextureIndex = RWTextures[1].DescriptorHeapIndex;
		computeData.roughTextureIndex = RWTextures[2].DescriptorHeapIndex;
		computeData.metalTextureIndex = RWTextures[3].DescriptorHeapIndex;
		computeData.noiseTextureIndex = RWTextures[4].DescriptorHeapIndex;

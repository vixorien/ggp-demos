...
private:
	...
	// Post processing options & resources
	...
	Microsoft::WRL::ComPtr<ID3D11RenderTargetView> colorRTV;		// Colors of the pixels
	...
	Microsoft::WRL::ComPtr<ID3D11RenderTargetView> metalRoughRTV;	// Material data (metalness and roughness)

	// SRVs for the render targets

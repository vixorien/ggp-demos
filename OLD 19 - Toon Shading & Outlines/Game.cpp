...
void Game::LoadAssetsAndCreateEntities()
{
	...
	// Grab meshes
	std::shared_ptr<Mesh> sphereMesh = assets.GetMesh(L"Meshes/sphere");
	std::shared_ptr<Mesh> torusMesh = assets.GetMesh(L"Meshes/torus");
	std::shared_ptr<Mesh> crateMesh = assets.GetMesh(L"Meshes/crate_wood");
	std::shared_ptr<Mesh> mandoMesh = assets.GetMesh(L"Meshes/mando");
	std::shared_ptr<Mesh> containerMesh = assets.GetMesh(L"Meshes/container");

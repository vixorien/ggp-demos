...
#undef LoadTexture
	...
	parallaxShapesMat->AddSampler(0, sampler);
	parallaxShapesMat->AddTextureSRV(0, shapesA);
	parallaxShapesMat->AddTextureSRV(1, shapesN);
	parallaxShapesMat->AddTextureSRV(2, shapesR);
	parallaxShapesMat->AddTextureSRV(3, shapesM);
	parallaxShapesMat->AddTextureSRV(4, shapesH);
	...
	parallaxStonesMat->AddSampler(0, sampler);
	parallaxStonesMat->AddTextureSRV(0, stonesA);
	parallaxStonesMat->AddTextureSRV(1, stonesN);
	parallaxStonesMat->AddTextureSRV(2, stonesR);
	parallaxStonesMat->AddTextureSRV(3, stonesM);
	parallaxStonesMat->AddTextureSRV(4, stonesH);
	...
	parallaxLeatherMat->AddSampler(0, sampler);
	parallaxLeatherMat->AddTextureSRV(0, leatherA);
	parallaxLeatherMat->AddTextureSRV(1, leatherN);
	parallaxLeatherMat->AddTextureSRV(2, leatherR);
	parallaxLeatherMat->AddTextureSRV(3, leatherM);
	parallaxLeatherMat->AddTextureSRV(4, leatherH);
	...
	parallaxBricksMat->AddSampler(0, sampler);
	parallaxBricksMat->AddTextureSRV(0, bricksA);
	parallaxBricksMat->AddTextureSRV(1, bricksN);
	parallaxBricksMat->AddTextureSRV(2, bricksR);
	parallaxBricksMat->AddTextureSRV(3, bricksM);
	parallaxBricksMat->AddTextureSRV(4, bricksH);
...
void Game::Draw(float deltaTime, float totalTime)
{
	...
	for (auto& e : entities)
	{
		...
		psData.parallaxSamples = parallaxOptions.SampleCount;
		psData.heightScale = parallaxOptions.HeightScale;

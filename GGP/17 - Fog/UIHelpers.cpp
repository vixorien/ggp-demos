	...
	FogOptions& fogOptions)
{
	...
	ImGui::Begin("Inspector");
	{
		...
		if (ImGui::TreeNode("Fog"))
		{
			...
			{
				ImGui::SliderFloat("Fog Start Dist", &fogOptions.FogStartDistance, 0.0f, 100.0f);
				ImGui::SliderFloat("Fog End Dist", &fogOptions.FogEndDistance, 0.0f, 100.0f);
			}
			else if (fogOptions.FogType == 2)
			{
				ImGui::SliderFloat("Fog Density", &fogOptions.FogDensity, 0.0f, 1.0f);
			}

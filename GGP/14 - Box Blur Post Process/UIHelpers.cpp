	...
	DemoBlurOptions& blurOptions)
{
	...
	ImGui::Begin("Inspector");
	{
		...
		{
			ImGui::Checkbox("Post Processing On", &blurOptions.PostProcessOn);
			ImGui::SliderInt("Blur Distance", &blurOptions.BlurDistance, 0, 50);
			...
			if (blurOptions.PostProcessOn)
			{
				...
				ImGui::Image(blurOptions.PostProcessSRV.Get(), size);
			}

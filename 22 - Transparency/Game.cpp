...
void Game::LoadAssetsAndCreateEntities()
{
	...
	fenceMat->AddTextureSRV("Albedo", assets.GetTexture("Textures/PBR/Transparent/fence_albedo"));
	fenceMat->AddTextureSRV("NormalMap", assets.GetTexture("Textures/PBR/Transparent/fence_normals"));
	fenceMat->AddTextureSRV("RoughnessMap", assets.GetTexture("Textures/PBR/Transparent/fence_roughness"));
	fenceMat->AddTextureSRV("MetalMap", assets.GetTexture("Textures/PBR/Transparent/fence_metal"));
	...
	latticeMat->AddTextureSRV("Albedo", assets.GetTexture("Textures/PBR/Transparent/lattice_albedo"));
	latticeMat->AddTextureSRV("NormalMap", assets.GetTexture("Textures/PBR/Transparent/lattice_normals"));
	latticeMat->AddTextureSRV("RoughnessMap", assets.GetTexture("Textures/PBR/Transparent/lattice_roughness"));
	latticeMat->AddTextureSRV("MetalMap", assets.GetTexture("Textures/PBR/Transparent/lattice_metal"));
	...
	glassWindowMat->AddTextureSRV("Albedo", assets.GetTexture("Textures/PBR/Transparent/glass_window_albedo"));
	glassWindowMat->AddTextureSRV("NormalMap", assets.GetTexture("Textures/PBR/Transparent/glass_window_normals"));
	glassWindowMat->AddTextureSRV("RoughnessMap", assets.GetTexture("Textures/PBR/Transparent/glass_window_roughness"));
	glassWindowMat->AddTextureSRV("MetalMap", assets.GetTexture("Textures/PBR/Transparent/glass_window_metal"));
	...
	glassPatternMat->AddTextureSRV("Albedo", assets.GetTexture("Textures/PBR/Transparent/glass_pattern_albedo"));
	glassPatternMat->AddTextureSRV("NormalMap", assets.GetTexture("Textures/PBR/Transparent/glass_pattern_normals"));
	glassPatternMat->AddTextureSRV("RoughnessMap", assets.GetTexture("Textures/PBR/Transparent/glass_pattern_roughness"));
	glassPatternMat->AddTextureSRV("MetalMap", assets.GetTexture("Textures/PBR/Transparent/glass_pattern_metal"));

	// Get meshes needed below
	std::shared_ptr<Mesh> cubeMesh = assets.GetMesh("Models/cube");
...
void Game::Draw(float deltaTime, float totalTime)
{
	...
	if (sortTransparentObjects)
	{
		...
		std::sort(
			...
			[&](GameEntity* a, GameEntity* b) -> bool
			{
				// Grab vectors
...
// --------------------------------------------------------
void Game::DrawOneEntity(GameEntity* entity, bool flipNormal)
{
	// Ensure each entity has the correct pixel shader
	Assets& assets = Assets::GetInstance();
	entity->GetMaterial()->SetPixelShader(usePBR ? assets.GetPixelShader("PixelShaderPBR") : assets.GetPixelShader("PixelShader"));

...
#define LoadTexture(path, srv) CreateWICTextureFromFile(Graphics::Device.Get(), Graphics::Context.Get(), FixPath(path).c_str(), 0, srv.GetAddressOf());
	...
	LoadTexture(L"../../../Assets/Textures/PBR/lava_albedo.png", lavaA);
	LoadTexture(L"../../../Assets/Textures/PBR/lava_normals.png", lavaN);
	LoadTexture(L"../../../Assets/Textures/PBR/lava_roughness.png", lavaR);
	LoadTexture(L"../../../Assets/Textures/PBR/lava_metal.png", lavaM);
	LoadTexture(L"../../../Assets/Textures/PBR/lava_emissive.png", lavaE);
#undef LoadTexture
	...
	lavaMat->AddTextureSRV("Albedo", lavaA);
	lavaMat->AddTextureSRV("NormalMap", lavaN);
	lavaMat->AddTextureSRV("RoughnessMap", lavaR);
	lavaMat->AddTextureSRV("MetalMap", lavaM);
	lavaMat->AddTextureSRV("EmissiveMap", lavaE);
...
void Game::Draw(float deltaTime, float totalTime)
{
	...
	for (auto& e : *currentScene)
	{
		...
		ps->SetInt("useEmissiveMap", (int)lightOptions.UseEmissiveMap);
